...
const ContactLink = ({ href, icon, label }) => (
  <a
    ...
    className="flex items-center gap-3 px-6 py-4 bg-gray-900 border border-gray-800 hover:border-purple-500 rounded-xl text-gray-300 hover:text-purple-400 transition duration-300 group"
  >
